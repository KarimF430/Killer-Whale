    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-white border-b">
                <div className="px-4 py-4 max-w-7xl mx-auto">
                    <h1 className="text-xl font-bold text-gray-900">
                        {carName} <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Images</span>
                    </h1>
            ...
            <div className="px-4 pb-8 max-w-7xl mx-auto">
                <Link
                    href={`/${galleryData.brandSlug}-cars/${galleryData.modelSlug}`}
                    className="block text-center bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent font-semibold hover:opacity-80 transition-opacity"
                    prefetch={false}
                >
