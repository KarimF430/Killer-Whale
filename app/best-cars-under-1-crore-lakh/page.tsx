...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `/best-cars-under-1-crore-lakh`
    }
}
...
export default async function BestCarsUnder1CrorePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Breadcrumb items={[{ label: 'Best Cars Under 1 Crore' }]} />
            <Footer />
        </div>
    )
}
