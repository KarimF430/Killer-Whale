...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `/best-cars-under-30-lakh`
    }
}
...
export default async function BestCarsUnder30LakhPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Breadcrumb items={[{ label: 'Best Cars Under 30 Lakh' }]} />
            <Footer />
        </div>
    )
}
