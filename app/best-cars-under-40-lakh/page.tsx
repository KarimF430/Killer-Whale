...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `/best-cars-under-40-lakh`
    }
}
...
export default async function BestCarsUnder40LakhPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Breadcrumb items={[{ label: 'Best Cars Under 40 Lakh' }]} />
            <Footer />
        </div>
    )
}
