...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `/best-cars-under-80-lakh`
    }
}
...
export default async function BestCarsUnder80LakhPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Breadcrumb items={[{ label: 'Best Cars Under 80 Lakh' }]} />
            <Footer />
        </div>
    )
}
