          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <div className="relative mb-6">
              <input
                ...
                placeholder="Ask me anything... 'Best car for family under 15 lakhs'"
            ...
            <button
              onClick={handleSearchClick}
              className="w-full bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-200 flex items-center justify-center space-x-3 text-lg hover:shadow-xl"
            >
