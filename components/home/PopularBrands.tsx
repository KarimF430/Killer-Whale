    ...
    <section className="py-12 lg:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Link key={brand.id} href={brand.href} className="group cursor-pointer">
                <div className="bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="w-16 h-16 mx-auto mb-4 bg-white rounded-full flex items-center justify-center shadow-sm">
                    ...
                    <span className={`text-2xl font-bold text-red-600 ${brand.logo && brand.logo.startsWith('http') ? 'hidden' : ''}`}>
                      {brand.name.charAt(0)}
                    </span>
                  </div>
        ...
        <div className="text-center mt-8 lg:mt-12">
          <Link
            href="/brands"
            className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-red-600 to-orange-500 text-white text-lg font-semibold rounded-full hover:from-red-700 hover:to-orange-600 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
