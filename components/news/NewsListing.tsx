...
export default function NewsListing() {
  ...
  // Mock news articles for fallback (keep a few for demo)
  const mockArticles: any[] = [
    {
      id: 1,
      title: 'New Mini Countryman SE All4 Launched in India at Rs. 66.90 Lakh',
      excerpt: 'Mini has launched the new Countryman SE All4 in India with advanced features and electric powertrain options.',
    ...
    {
      id: 2,
      title: '30,000 Mahindra Electric SUVs Sold in Seven Months',
      excerpt: 'Mahindra achieves milestone with 30k eSUVs sold, showcasing strong demand for electric vehicles in India.',
      author: 'Haji Chakralwale',
      publishedDate: '14 Mar',
      readTime: 4,
      views: 18200,
      comments: 67,
      image: '/api/placeholder/400/250',
    ...
    {
      id: 4,
      title: 'New Hyundai Venue: Variant-wise Features and Prices Explained',
      excerpt: 'Complete breakdown of Hyundai Venue variants, features, and pricing across all trim levels.',
      author: 'Sagar Bhanushali',
      publishedDate: '12 Mar',
      readTime: 6,
      views: 15600,
      comments: 52,
      image: '/api/placeholder/400/250',
    ...
    {
      id: 5,
      title: 'Maruti to Launch 8 New SUVs, Projects Capturing 50pc Market Share',
      excerpt: 'Maruti Suzuki announces aggressive expansion plan with 8 new SUVs targeting 50% market share.',
      author: 'Dwij Bhandut',
      publishedDate: '11 Mar',
      readTime: 5,
      views: 19800,
      comments: 73,
      image: '/api/placeholder/400/250',
    ...
    {
      id: 6,
      title: 'Honda City 5th Generation: Complete Review and Road Test',
      excerpt: 'Comprehensive review of the latest Honda City covering performance, features, and value for money.',
      author: 'Priya Sharma',
    ...
    },
    {
      ...
      excerpt: 'All upcoming electric vehicles launching in India this year with expected prices and specifications.',
      author: 'Amit Verma',
      publishedDate: '9 Mar',
      readTime: 7,
      views: 22100,
    ...
    {
      id: 8,
      title: 'Tata Nexon EV Facelift Spotted Testing with New Design',
      excerpt: 'Spy shots reveal Tata Nexon EV facelift with updated styling and enhanced features coming soon.',
      author: 'Vikram Singh',
      publishedDate: '8 Mar',
      readTime: 4,
      views: 16700,
  ...
  // Use real articles or fallback to mock
  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Car News</h1>
        </div>
                    ...
                    >
                      ...
                      <div className="relative h-48 bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 flex items-center justify-center p-6">
                        ...
                        <div className="absolute top-4 left-4 flex gap-2 z-10">
                          {article.isFeatured && (
                            <span className="px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-red-500 to-orange-500">
                              Featured
                            </span>
                          )}
                          {article.isBreaking && (
