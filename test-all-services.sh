...
# SECURITY: Do not hardcode production credentials here.
# Use environment variables or local MongoDB for testing.
MONGODB_URI="${MONGODB_URI:-mongodb://localhost:27017/gadizone}"
